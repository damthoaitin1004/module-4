...
public class BookController {
    ...
    @PostMapping("/give")
    public String giveBook(@RequestParam int nameBookCode, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("msg", "Cảm ơn bạn đã tin dùng dịch vụ");
